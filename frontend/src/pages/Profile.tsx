...
const profileReviews = [
  {
    ...
    rating: 5,
    reviewText: "Villeneuve has outdone himself yet again. The third installment brings the saga to a breathtaking conclusion.",
  ...
  },
  {
    ...
    rating: 4,
    reviewText: "A thoughtful exploration of parallel lives. Heartwarming and deeply personal.",
    author: { name: "Sarah Chen", avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&h=80&fit=crop&crop=face" },
    likes: 189,
    comments: 32,
  },
      ...
      <div className="container mx-auto px-4 -mt-16 relative z-10 pb-12">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="font-display text-2xl sm:text-3xl font-bold">Sarah Chen</h1>
              <p className="text-muted-foreground text-sm">@sarahchen</p>
            </div>
            <Button variant="outline" className="rounded-xl">Edit Profile</Button>
          </div>

          <p className="text-sm text-muted-foreground max-w-xl mb-4">
            Avid reader, film lover, and course collector. I review everything I consume and love connecting with fellow enthusiasts. Always looking for the next great story.
          </p>

          <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6">
            <span className="flex items-center gap-1"><MapPin className="w-3.5 h-3.5" /> San Francisco</span>
            <span className="flex items-center gap-1"><Calendar className="w-3.5 h-3.5" /> Joined Mar 2024</span>
        ...
        <Tabs defaultValue="reviews">
          <TabsList className="bg-card border border-border rounded-xl mb-6 p-1">
            ...
            <TabsTrigger value="lists" className="rounded-lg">Lists</TabsTrigger>
          ...
          <TabsContent value="lists">
            <div className="text-center py-16">
              ...
              <Button variant="outline" className="rounded-xl mt-2">Create a List</Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="watchlist">
            <div className="text-center py-16">
              ...
              <p className="text-sm text-muted-foreground">Start adding items to watch later</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
